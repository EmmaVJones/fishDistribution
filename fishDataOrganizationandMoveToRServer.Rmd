...
fishStationsFixed <- read_excel('EDASdata/Stations.xlsx', sheet = 'EVJfixes')
...
fishStations <- filter(fishStations, Type != 'Test Site') # drop test site
```
...
write_csv(taxaByHUC8, 'data/taxaByHUC8.csv', na = "")
