...
stations <- '4ALOR005.92'#c('2-HAZ006.91', '2-JMS330.79', '2-LMC001.37','4AFSF013.80', '1AGOO039.63')
dateRange <- c(as.Date('2000-01-01'), as.Date(Sys.Date()- 7))# as.Date('2022-01-01'))#
repFilter <- c('1', '2')
sumFish <- TRUE
